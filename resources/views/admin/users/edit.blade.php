...
@section('content')
    <div class="container mt-4" style="max-width: 700px;">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2><i class="bi bi-pencil-square" style="color: #22c55e;"></i> Edit User</h2>
            ...
            <form action="/admin/users/{{ $user->id }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="role" class="form-select" required style="border-radius: 10px; border-color: #cbd5e1;">
                        ...
                        <option value="penyelenggara" {{ $user->role === 'penyelenggara' ? 'selected' : '' }}>⭐
                ...
                <div class="mb-3">
                    <label class="text-dark">Password Baru <small style="color: #64748b;">(kosongkan jika tidak ingin
