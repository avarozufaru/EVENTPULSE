    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0"><i class="bi bi-pencil-square me-2" style="color: #a78bfa;"></i>Edit Event</h2>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-lg" style="border-radius: 12px; overflow: hidden;">
                                    ...
                                    <input type="number" name="harga" class="form-control border-0" value="{{ $event->harga }}" min="0" style="background: rgba(255,255,255,0.06);">
                                </div>
                            </div>
                        </div>

                        <div class="mb-4">
                            <label class="form-label"><i class="bi bi-image-fill me-1 text-primary"></i> Banner / Poster Event</label>
                            @if($event->banner)
                                <div class="mb-3 text-center p-3 rounded" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08);">
                            ...
                            @endif
                            <div class="p-4 rounded text-center mb-2" style="background: rgba(255,255,255,0.03); border: 2px dashed rgba(255,255,255,0.15); border-radius: 12px; position: relative;">
                            ...
                            <div id="banner-preview" class="mt-3 text-center" style="display:none;">
                                <p class="text-warning small mb-2"><i class="bi bi-eye-fill me-1"></i>Preview banner baru:</p>
