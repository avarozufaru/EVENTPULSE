        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="mb-0"><i class="bi bi-plus-circle-fill me-2" style="color: #22c55e;"></i>Tambah Event</h2>
                        ...
                        <form action="/events" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="deskripsi" class="form-control" rows="5"
                                    placeholder="Tuliskan deskripsi lengkap mengenai event ini..." required style="border-radius: 12px; resize: none;"></textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="pembicara" class="form-control form-control-lg"
                                    placeholder="Nama pembicara atau narasumber" style="border-radius: 12px;">
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4 mb-3 mb-md-0">
                                    <label class="form-label"><i class="bi bi-clock-fill me-1" style="color: #22c55e;"></i>
                                        Jam Mulai</label>
                                    <input type="time" name="jam_mulai" class="form-control form-control-lg" required
                                        style="border-radius: 12px;">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="lokasi" class="form-control form-control-lg"
                                    placeholder="Contoh: Aula Utama Kampus A / Link Zoom" required
                                    style="border-radius: 12px;">
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    <label class="form-label"><i class="bi bi-people-fill me-1" style="color: #22c55e;"></i>
                                        Kuota</label>
                                    <input type="number" name="kuota" class="form-control form-control-lg" value="100"
                                        min="1" required style="border-radius: 12px;">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-lg"
                                        ...
                                        <input type="number" name="harga" class="form-control border-0"
                                            value="0" min="0" style="background: #f8fafc;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <label class="form-label"><i class="bi bi-image-fill me-1" style="color: #22c55e;"></i>
                                    Banner / Poster Event <span class="text-muted fs-6">(Opsional)</span></label>
                                <div class="p-4 rounded text-center mb-2"
                                    style="background: #f8fafc; border: 2px dashed rgba(34, 197, 94,0.3); border-radius: 12px;">
                                ...
                                <div id="banner-preview" class="mt-3 text-center" style="display:none;">
                                    <p class="small mb-2" style="color: #22c55e;"><i
                                            class="bi bi-eye-fill me-1"></i>Preview banner:</p>
                            ...
                            <div class="mb-5 p-3 rounded" style="background: #f0f7ff; border-left: 4px solid #22c55e;">
                                <div class="form-check form-switch d-flex align-items-center gap-2">
                                    <input class="form-check-input" type="checkbox" role="switch" name="is_featured"
                                        value="1" id="isFeatured" style="transform: scale(1.3); cursor: pointer;">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary-gradient btn-lg py-3"
                                    style="border-radius: 12px; font-size: 1.1rem; letter-spacing: 0.5px;">
