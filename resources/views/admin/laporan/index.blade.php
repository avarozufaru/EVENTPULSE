...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2><i class="bi bi-graph-up-arrow" style="color: #0ea5e9;"></i> Laporan Statistik</h2>
    ...
    <div class="row mb-4">
        <div class="col-md-4 mb-3">
            <div class="glass-box d-flex align-items-center justify-content-between p-4" style="border-left: 4px solid #0ea5e9; height: 100%;">
                ...
                <div style="font-size: 2.5rem; color: rgba(14,165,233,0.4);"><i class="bi bi-people-fill"></i></div>
            </div>
        </div>
        <div class="col-md-4 mb-3">
            <div class="glass-box d-flex align-items-center justify-content-between p-4" style="border-left: 4px solid #38bdf8; height: 100%;">
                ...
                <div style="font-size: 2.5rem; color: rgba(56,189,248,0.4);"><i class="bi bi-calendar-check-fill"></i></div>
            </div>
        </div>
        <div class="col-md-4 mb-3">
            <div class="glass-box d-flex align-items-center justify-content-between p-4" style="border-left: 4px solid #10b981; height: 100%;">
                ...
                <div style="font-size: 2.5rem; color: rgba(16,185,129,0.4);"><i class="bi bi-ticket-perforated-fill"></i></div>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-md-8 mb-4">
            <div class="glass-box h-100">
                <h5 class="mb-4" style="color: #0f172a;"><i class="bi bi-bar-chart-fill" style="color: #0ea5e9;"></i> Top 10 Event Pendaftar Terbanyak</h5>
        ...
        <div class="col-md-4 mb-4">
            <div class="glass-box h-100">
                <h5 class="mb-4" style="color: #0f172a;"><i class="bi bi-pie-chart-fill text-warning"></i> Event per Kategori</h5>
    ...
    <div class="row">
        <div class="col-12">
            <div class="glass-box">
                <h5 class="mb-4" style="color: #0f172a;"><i class="bi bi-graph-up text-success"></i> Tren Registrasi Tiket (6 Bulan Terakhir)</h5>
