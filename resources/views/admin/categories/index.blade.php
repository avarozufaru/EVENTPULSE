...
@section('content')
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2><i class="bi bi-tags-fill" style="color: #22c55e;"></i> Kelola Kategori</h2>
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    <span class="badge"
                                        style="background: rgba(34, 197, 94,0.1); color: #16a34a; border: 1px solid rgba(34, 197, 94,0.2); padding: 5px 10px; border-radius: 12px;">
                                        {{ $eventCount }} Event
                                    </span>
                                </td>
                                <td><span
                                        style="color: #64748b;">{{ \Carbon\Carbon::parse($category->created_at)->format('d M Y') }}</span>
                                </td>
                                <td>
                                    <div class="d-flex gap-1">
                                        <button type="button" class="btn btn-sm btn-edit"
                                            style="background: rgba(34, 197, 94,0.1); color: #16a34a; border: 1px solid rgba(34, 197, 94,0.2);"
                                            onclick="editCategory({{ $category->id }}, '{{ addslashes($category->nama) }}')">
                                        ...
                                        <form action="/admin/categories/{{ $category->id }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-sm btn-delete-cat"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content"
                ...
                <div class="modal-header border-bottom-0 pb-0">
                    <h5 class="modal-title" style="color: #0f172a;"><i class="bi bi-tag-fill me-2"
                            style="color: #22c55e;"></i> Tambah Kategori</h5>
                    ...
                    <div class="modal-body py-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama"
                                placeholder="Contoh: Seminar, Workshop, Lomba" required
    ...
    <div class="modal fade" id="editCategoryModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content"
                style="background: #ffffff; border: 1px solid rgba(34, 197, 94,0.2); border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                <div class="modal-header border-bottom-0 pb-0">
                    <h5 class="modal-title" style="color: #0f172a;"><i class="bi bi-pencil-square me-2"
                            style="color: #22c55e;"></i> Edit Kategori</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
